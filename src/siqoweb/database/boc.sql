...
/* Resources */
/*----------------------------------------------------------------------------------------------*/
INSERT INTO PM_OBJ_RESOURCE VALUES( 'PagManHomepage', 'Stage_BOC', '0_Stage', 'SK',   'A', 'Battle of consistency',     DATE('now'), DATE('now'), 'SIQO');
INSERT INTO PM_OBJ_RESOURCE VALUES( 'PagManHomepage', 'Stage_BOC', '0_Stage', 'POS',  'A', '5',                         DATE('now'), DATE('now'), 'SIQO');

INSERT INTO PM_OBJ_RESOURCE VALUES( 'PagManHomepage', 'Stage_BOC', '1_Item',  'SK',   'A', 'Battle of consistency',     DATE('now'), DATE('now'), 'SIQO');
...
INSERT INTO PM_OBJ_RESOURCE VALUES( 'PagManHomepage', 'Stage_BOC', '6_Item',  'SK',   'A', 'Battle of consistency is ', DATE('now'), DATE('now'), 'SIQO');
...
/*----------------------------------------------------------------------------------------------*/
INSERT INTO PM_OBJ_RESOURCE VALUES( 'PageBOC',  'HeadItems',   '1_Title',    'SK',    'A', 'Battle of consistency',     DATE('now'), DATE('now'), 'SIQO');
